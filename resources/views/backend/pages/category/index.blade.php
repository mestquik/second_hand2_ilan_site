...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">KATEGORİ YÖNETİMİ</p>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="display expandable-table" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th  style="text-align:center;">Toplam Alt Kategori</th>
                                    ...
                                    @if(!empty($categories) && $categories->count()>0)
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">{{$data[$category->id]}}</td>
                                    ...
                                    @else
                                        <tr>
                                            <td class="py-1">
                                                <h3 style="text-align: center">Kategori bulunamadı</h3>
                                            </td>
                                        </tr>
