...
@section('content')
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title">Yeni Kategori Oluşturma</h4>
                ...
                <form class="forms-sample" action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <button class="file-upload-browse btn btn-primary" type="button">Resmi Yükle</button>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="contentt" name="content" placeholder="Açıklama"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button  class="btn btn-light"><a href="{{route('category.index')}}">İptal</a></button>
                </form>
