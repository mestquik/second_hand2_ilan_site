        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{route('homepage')}}">Anasayfa</a> <span
                        class="mx-2 mb-0">/</span> <strong class="text-black">İletişim</strong></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="h3 mb-3 text-black">Bilgileriniz</h2>
                </div>
                <div class="col-md-7">
                    ...
                    <form action="{{route('save-contact')}}" method="post">
                        ...
                        <div class="p-3 p-lg-5 border">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="c_fname" class="text-black">İsim Soyisim <span
                ...
                <div class="col-md-5 ml-auto">
                    <div class="p-4 border mb-3">
                        ...
                        <p class="mb-0">Kağıthane/Sarıyer İş Merkezi</p>
                    </div>
                    <div class="p-4 border mb-3">
                    ...
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">Bursa</span>
                        <p class="mb-0">İşgeçmez Hanı no:2</p>
                    </div>
