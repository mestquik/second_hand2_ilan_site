...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0"><a href="{{route('homepage')}}">Anasayfa</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Sepetim</strong></div>
        </div>
    </div>
</div>
                ...
                <div class="site-blocks-table">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="product-remove">Sepetten Çıkart</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>İndirim Kuponunuz mevcutsa kullanabilirsiniz</p>
                    </div>
                    <div class="col-md-8 mb-3 mb-md-0">
                        <input type="text" class="form-control py-3" id="coupon" placeholder="Kupon Alanı">
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-primary btn-sm">Kuponu Kullan</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-12 text-right border-bottom mb-5">
                                <h3 class="text-black h4 text-uppercase">Kart Toplamı</h3>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
